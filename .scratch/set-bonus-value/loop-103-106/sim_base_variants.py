...
REQ_DIR = ROOT / ".scratch/set-bonus-value/loop-103-106/base-variants"
OUT = ROOT / ".scratch/set-bonus-value/loop-103-106/sims-10"
...
def main() -> None:
    ...
    for t in tags:
        if t == "B0_BASE":
            continue
        d = [p - q for p, q in zip(per_seed[t], per_seed["B0_BASE"])]
