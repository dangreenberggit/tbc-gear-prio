...
- Give the response a title.
- Put the final answer in its own labelled section at the end. Write it so it stands alone — assume the reader did not read the reasoning above it.
