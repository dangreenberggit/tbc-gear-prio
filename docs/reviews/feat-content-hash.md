...
| A3      | Adversarial          | defer       | `.scratch/carry-forward/issues/29-job-row-stranded-on-meta-unsolvable.md`                                                                                            |
...
| S4      | Spec                 | defer       | `.scratch/carry-forward/issues/30-viewoptions-gate-not-pinned-through-applyview.md` (`Blocks: phase-1` — it is an open §14 box)                                      |
