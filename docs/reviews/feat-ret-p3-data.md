...
| A2  | Adversarial | defer       | `.scratch/carry-forward/issues/158-universe-artifacts-record-no-ep-weights-provenance.md` — folded into its done-when (same function); trivial cleanup, no behaviour change                                                                                                                                                                                                                |
...
| D2  | Domain      | defer       | `.scratch/carry-forward/issues/158-universe-artifacts-record-no-ep-weights-provenance.md` — the EP file needs a lock entry / check alongside the provenance stamp. Stated **unverified**: the values were diffed against `ac0ed034b` and matched, but nothing re-checks them on the next sync                                                                                              |
| D3  | Domain      | defer       | `.scratch/carry-forward/issues/158-universe-artifacts-record-no-ep-weights-provenance.md` — same finding as A1, reached independently                                                                                                                                                                                                                                                      |
| S1  | Standards   | defer       | `.scratch/carry-forward/issues/160-per-file-pin-has-no-check-sync-wowsims-case.md`                                                                                                                                                                                                                                                                                                         |
| S2  | Standards   | defer       | `.scratch/carry-forward/issues/158-universe-artifacts-record-no-ep-weights-provenance.md` — same function, one-line comment fix                                                                                                                                                                                                                                                            |
| S3  | Standards   | defer       | `.scratch/carry-forward/issues/158-universe-artifacts-record-no-ep-weights-provenance.md` — the EP-file lock entry supersedes the prose `pin` field                                                                                                                                                                                                                                        |
...
| SP2 | Spec        | defer       | `.scratch/carry-forward/issues/158-universe-artifacts-record-no-ep-weights-provenance.md` — same finding as A1                                                                                                                                                                                                                                                                             |
| SP3 | Spec        | defer       | `.scratch/carry-forward/issues/160-per-file-pin-has-no-check-sync-wowsims-case.md` for the test cover. D2 pin discipline verified intact (main pin unmoved, one override), so no separate ticket                                                                                                                                                                                           |
