...
| A3  | Adversarial | defer       | `.scratch/carry-forward/issues/75-boss-flag-has-no-validation.md`                                                                                                                   |
| A4  | Adversarial | defer       | `.scratch/carry-forward/issues/80-unused-rank-error-kinds-and-bare-error-escape.md`                                                                                                 |
| D1  | Domain      | defer       | `.scratch/carry-forward/issues/76-html-report-missing-hit-cap-and-provenance.md`                                                                                                    |
| D2  | Domain      | defer       | `.scratch/carry-forward/issues/77-unrounded-gap-after-in-html-report.md`                                                                                                            |
| D3  | Domain      | defer       | `.scratch/carry-forward/issues/81-idols-flagged-enchantable.md`                                                                                                                     |
| S1  | Standards   | defer       | `.scratch/carry-forward/issues/78-sqlitestore-and-cachinggearsource-unreachable.md`                                                                                                 |
| S2  | Standards   | defer       | `.scratch/carry-forward/issues/79-barrel-export-inconsistency-for-fixture-builders.md`                                                                                              |
...
| SP3 | Spec        | defer       | `.scratch/carry-forward/issues/82-stale-feral-structural-change-verification-command.md`                                                                                            |
| SP4 | Spec        | defer       | `.scratch/carry-forward/issues/74-verification-log-ret-universe-claim-is-wrong.md`                                                                                                  |
