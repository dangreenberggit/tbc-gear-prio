...
| S4  | Spec         | defer       | `.scratch/carry-forward/issues/162-upgrades-tab-ignores-user-set-ep-weights.md` — recorded in its comment; strengthening the test is v2 work, and v2 is deliberately unbuilt                                                                                           |
